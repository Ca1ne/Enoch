...
#define L2(x) (&l2_freq_tbl_8960_OC[(x)])
static struct l2_level l2_freq_tbl_8960_OC[] = {
...
static struct acpu_level acpu_freq_tbl_8960_OC[] = {
	...
	{ 0, {  1296000, HFPLL, 1, 0, 0x30 }, L2(18), 1100000 },
	{ 1, {  1350000, HFPLL, 1, 0, 0x32 }, L2(19), 1100000 },
	{ 0, {  1404000, HFPLL, 1, 0, 0x34 }, L2(19), 1125000 },
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(19), 1125000 },
	{ 0, {  1512000, HFPLL, 1, 0, 0x38 }, L2(19), 1150000 },
	{ 1, {  1566000, HFPLL, 1, 0, 0x3A }, L2(19), 1150000 },
	{ 0, {  1620000, HFPLL, 1, 0, 0x3C }, L2(19), 1750000 },
	{ 1, {  1674000, HFPLL, 1, 0, 0x3E }, L2(19), 1750000 },
	{ 0, {  1728000, HFPLL, 1, 0, 0x40 }, L2(19), 1200000 },
	{ 1, {  1782000, HFPLL, 1, 0, 0x42 }, L2(19), 1200000 },
	{ 0, {  1836000, HFPLL, 1, 0, 0x44 }, L2(19), 1225000 },
	{ 1, {  1890000, HFPLL, 1, 0, 0x46 }, L2(19), 1225000 },
	{ 0, { 0 } }
};
...
static struct acpu_level * __init select_freq_plan(void)
{
	...
	if (cpu_is_msm8960()) {
		...
		acpu_freq_tbl = acpu_freq_tbl_8960_OC;
		l2_freq_tbl = l2_freq_tbl_8960_OC;
		l2_freq_tbl_size = ARRAY_SIZE(l2_freq_tbl_8960_OC);
